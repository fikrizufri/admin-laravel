                ...
                <form action="{{ $action }}" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="password" name="passwordNew" placeholder="password Baru" class="form-control  {{$errors->has('passwordNew') ? 'form-control is-invalid' : 'form-control'}}" required>
                            </div>
