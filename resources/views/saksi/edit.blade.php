                    ...
                    <div class="card-body">
                        <div class="form-group ">
                            ...
                            <select name="tps_id" class="selected2 form-control" id="cmbtps">
                                ...
                                <option value="{{$tps->id}}" {{$saksi->tps_id == $tps->id ? "selected" : ""}}>{{'No TPS : '.$tps->nama.', Kelurahan : '.$tps->nama_kelurahan.', Kecamatan : '.$tps->nama_kecamatan.', Kabupaten : '.$tps->nama_kabupaten}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="nama" placeholder="Nama {{$title}}" id="nama" class="form-control  {{$errors->has('nama') ? 'form-control is-invalid' : 'form-control'}}" value="{{$saksi->nama}}" required>
                            </div>
                            @if ($errors->has('nama'))
                            <span class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="nik" placeholder="NIK {{$title}}" id="nik" class="form-control  {{$errors->has('nik') ? 'form-control is-invalid' : 'form-control'}}" value="{{$saksi->nik}}" required>
                            </div>
                            @if ($errors->has('nik'))
                            <span class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="nohp" placeholder="No HP {{$title}}" id="nohp" class="form-control  {{$errors->has('nohp') ? 'form-control is-invalid' : 'form-control'}}" value="{{$saksi->nohp}}" required>
                            </div>
                            @if ($errors->has('nohp'))
                            <span class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="alamat" placeholder="Alamat {{$title}}" id="alamat" class="form-control  {{$errors->has('alamat') ? 'form-control is-invalid' : 'form-control'}}" value="{{$saksi->alamat}}" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" value="{{$saksi->foto}}" name="foto" id="icon" class="form-control">
                        </div>
                        <div class="preview"></div>
                        <img class="img-profile img-responsive" width="20%" @if ($saksi->foto == NULL )
                        src="{{asset('img/default-icon.png')}}"
                        @else
                        src="{{ asset('storage/saksi/thumbnail/'.$saksi->foto)}}"
                        @endif>
                        <div>
                            @if ($errors->has('foto'))
