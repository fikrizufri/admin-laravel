      ...
      <div class="card">
        ...
        <div class="card-body">
          <table class="table table-bordered">
            ...
            <tbody>
              @forelse ($dataPaslon as $index => $item)

              <tr>
                <td>{{ $index+1+(($dataPaslon->CurrentPage()-1)*$dataPaslon->PerPage()) }}</td>
                <td><img style="width: 100px; height: 100px;" @if ($item->foto != NULL )
                  src="{{ asset('storage/paslon/thumbnail/'.$item->foto)}}"
                  @else
